...
const PostAssigment = () => {
  ...
  <div class="form">
    ...
    <form class="login-form">
      ...
      <input value={date} onChange={(e) => setDate(e.target.value)} type="datetime-local" placeholder="Due Date"/>
      <input type="file"  onChange={(e) => {
                       
                        setDocFile(e.target.files[0]);
                      }}/>
      <textarea value={comment} onChange={(e) => setComment(e.target.value)} placeholder='Comment'  name="" id="" cols="30" rows="10"></textarea>
